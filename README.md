...
**setters**: serve para validar atributos na hora em que são definidos, por exemplo se voce quer dar um valor lara rodas do carro, não pode ser -1 ou 100000000000, o set vai validar isso. SIntaxe atual => set
